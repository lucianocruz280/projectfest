                ...
                <div class="col-md-4 col-sm-12">
                    <div class="paneleditev">
                        <div class="eventitle">
                           <div class="texttitle">
                            <a href="#eventos" >
                            <h3 class="section-description">Agregar Evento</h3>
                            </div>
                            <div class="icontitle">
                            <span class="glyphicon glyphicon-plus"></span></a>
                            </div>
                        </div>
                        <div class="evenbody " id="eventos">
                           <div class="well">
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="paneleditev">
                        <div class="eventitle">
                           <div class="texttitle">
                            <a href="#">
                            <h3 class="section-description">Agregar Organizador</h3>
                            </div>
                            <div class="icontitle">
                            <span class="glyphicon glyphicon-plus"></span></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="paneleditev">
                        <div class="eventitle">
                           <div class="texttitle">
                            <a href="#">
                            <h3 class="section-description">Agregar Repartidor de Pulseras</h3>
                            </div>
                            <div class="icontitle">
                            <span class="glyphicon glyphicon-plus"></span></a>
                            </div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="paneleditev">
                        ...
                        <div class="eventsubtitle">
                            <h4 class="section-description-left">Evento #1 -- Calle Montaña #407 -- Colonia Alarcón -- 23/09/2017 -- $50</h4>
                        </div>
                        <div class="evenbody">
